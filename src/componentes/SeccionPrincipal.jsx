    ...
    return (
        <main>
            ...
            <section id="platos-destacados">
                <section class="platos-destacados-main">
                    <h2>Nuestros platos más destacados</h2>
                    <div class="flex-container">
                        <div class="plato">
                            <img class="plato-img1" src={lomo} alt="" />
                            <p>Lomo Sabor Y Alma</p>
                        </div>
                        <div class="plato">
                            <img class="plato-img1" src={pulpo} alt="" />
                            <p>Pulpo Sabor Y Alma</p>
                        </div>
                        <div class="plato">
                            <img class="plato-img1" src={rollitosHesei} alt="" />
                            <p>Rollitos Heisei</p>
                        </div>
                        <div class="plato">
                            <img class="plato-img1" src={polloTrudado} alt="" />
                            <p>Pollo trufado</p>
                        </div>
                    </div>
                </section>
                <div class="boton-menu">
                    <a href="./HTML/menu.html" class="btn">Conoce nuestro menú</a>
                </div>
            </section>
            ...
            <section class="logo-relleno" id="logo-relleno-home">
